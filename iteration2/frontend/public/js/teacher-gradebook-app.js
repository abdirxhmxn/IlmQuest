...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // frontend/src/teacher-gradebook-app.js
  window.Alpine = module_default;
  window.htmx = htmx_esm_default;
  module_default.data("gradebookDrawer", () => ({
    open: false,
    selectedCell: null,
    init() {
      this.open = false;
  ...
  (function teacherGradebookApp() {
    ...
    const pendingMutations = /* @__PURE__ */ new Map();
    const undoStack = [];
    let currentTabClassId = String(payload.activeClassId || ((_a = classes == null ? void 0 : classes[0]) == null ? void 0 : _a.id) || "");
    ...
    function getActiveClassPanel() {
      return Array.from(document.querySelectorAll("[data-gradebook-class-panel]")).find((panel) => panel.classList.contains("is-active")) || null;
    }
    function resetPanelScroll(panelEl) {
      const scroller = panelEl == null ? void 0 : panelEl.querySelector(".gradebook-v1-scroll");
      if (!(scroller instanceof HTMLElement)) return;
      const moveToTrackerEdge = () => {
        var _a2, _b;
        const focusHeader = focusDateKey ? panelEl == null ? void 0 : panelEl.querySelector(`[data-tracker-date-group][data-date-key="${focusDateKey}"]`) : null;
        if (focusHeader instanceof HTMLElement) {
          const stickyColumnWidth = ((_b = (_a2 = panelEl == null ? void 0 : panelEl.querySelector(".gradebook-v1-student.sticky-col")) == null ? void 0 : _a2.getBoundingClientRect) == null ? void 0 : _b.call(_a2).width) || 220;
    ...
    async function readErrorMessage(response, fallbackMessage) {
      ...
      if (contentType.includes("application/json")) {
        ...
        return (data2 == null ? void 0 : data2.message) || fallbackMessage;
      }
    ...
    function buildDrawerOptionMarkup(detail) {
      var _a2;
      const options = Array.isArray(detail == null ? void 0 : detail.options) ? detail.options : [];
      const selectedMarkKey = String(((_a2 = detail == null ? void 0 : detail.cell) == null ? void 0 : _a2.markKey) || "");
      return [
        `<option value="">\u2014 Clear \u2014</option>`,
        ...options.map((option) => {
          const optionKey = String((option == null ? void 0 : option.key) || "");
          const symbol = escapeHtml((option == null ? void 0 : option.symbol) || "");
          const label = escapeHtml((option == null ? void 0 : option.label) || "");
          const selected = optionKey === selectedMarkKey ? " selected" : "";
          return `<option value="${escapeHtml(optionKey)}"${selected}>${symbol}${label ? ` \xB7 ${label}` : ""}</option>`;
        })
      ].join("");
    }
    function buildDrawerHistoryMarkup(detail) {
      const history2 = Array.isArray(detail == null ? void 0 : detail.history) ? detail.history : [];
      if (!history2.length) {
      ...
      <ul>
        ${history2.map((entry) => `
          <li class="${(entry == null ? void 0 : entry.isCurrent) ? "is-current" : ""}">
            <strong>${escapeHtml((entry == null ? void 0 : entry.markSymbol) || "\u2014")}</strong>
            <span>${escapeHtml((entry == null ? void 0 : entry.markLabel) || "Cleared")}</span>
            <small>${escapeHtml((entry == null ? void 0 : entry.action) || "set")} \xB7 #${escapeHtml((entry == null ? void 0 : entry.sequenceNumber) || 0)} \xB7 ${escapeHtml((entry == null ? void 0 : entry.actorName) || "Staff")} \xB7 ${escapeHtml((entry == null ? void 0 : entry.createdAtLabel) || "N/A")}</small>
          </li>
        `).join("")}
      </ul>
    `;
    ...
    function renderDrawerDetail(detail, savedMessage = "") {
      const cell = (detail == null ? void 0 : detail.cell) || {};
      return `
      <div class="gradebook-v1-drawer-head">
        <p class="gradebook-v1-kicker">Cell Details</p>
        <h3>${escapeHtml((detail == null ? void 0 : detail.studentName) || "Student")}</h3>
        <p>${escapeHtml((cell == null ? void 0 : cell.detailLabel) || "Grade Cell")} \xB7 ${escapeHtml((detail == null ? void 0 : detail.periodName) || "")}</p>
      ...
      <form class="gradebook-v1-drawer-form" action="/api/teacher/gradebook/cell/detail" method="POST" data-gradebook-drawer-form>
        ...
        <input type="hidden" name="classId" value="${escapeHtml((detail == null ? void 0 : detail.classId) || "")}">
        <input type="hidden" name="studentId" value="${escapeHtml((detail == null ? void 0 : detail.studentId) || "")}">
        <input type="hidden" name="gradingPeriodId" value="${escapeHtml((detail == null ? void 0 : detail.gradingPeriodId) || "")}">
        <input type="hidden" name="category" value="${escapeHtml((cell == null ? void 0 : cell.category) || "")}">
        <input type="hidden" name="dateKey" value="${escapeHtml((cell == null ? void 0 : cell.dateKey) || "")}">
        <input type="hidden" name="columnKey" value="${escapeHtml((cell == null ? void 0 : cell.columnKey) || "")}">
        <input type="hidden" name="assessmentId" value="${escapeHtml((cell == null ? void 0 : cell.assessmentId) || "")}">
        ...
        ${(cell == null ? void 0 : cell.category) === "subac" ? `
          <div class="gradebook-v1-drawer-grid">
            <label>
              <span>Reviewer</span>
              <input type="text" name="reviewer" maxlength="120" value="${escapeHtml((cell == null ? void 0 : cell.reviewer) || "")}">
            </label>
            <label>
              <span>Revision Portion</span>
              <input type="text" name="revisionPortion" maxlength="120" value="${escapeHtml((cell == null ? void 0 : cell.revisionPortion) || "")}">
            </label>
          </div>
        ` : ""}

        ${(cell == null ? void 0 : cell.category) === "behavior" ? `
          <label>
            <span>Behavior Subcategory</span>
            <input type="text" name="behaviorSubcategory" maxlength="80" value="${escapeHtml((cell == null ? void 0 : cell.behaviorSubcategory) || "")}" placeholder="Adab, focus, effort...">
          </label>
        ` : ""}

        ${(detail == null ? void 0 : detail.isClosed) && (detail == null ? void 0 : detail.postCloseEditEnabled) ? `
          <label class="gradebook-v1-drawer-check">
            <input type="checkbox" name="postCloseEdit" value="true"${(cell == null ? void 0 : cell.postCloseEdit) ? " checked" : ""}>
            <span>Mark this as a post-close edit</span>
          </label>
          <label>
            <span>Post-close reason</span>
            <textarea name="postCloseReason" rows="2" maxlength="240">${escapeHtml((cell == null ? void 0 : cell.postCloseReason) || "")}</textarea>
          </label>
        ` : ""}

        <label>
          <span>Internal Comment</span>
          <textarea name="internalComment" rows="4" maxlength="1600">${escapeHtml((cell == null ? void 0 : cell.internalComment) || "")}</textarea>
        </label>

        <label>
          <span>Parent-facing Comment</span>
          <textarea name="parentComment" rows="4" maxlength="1600">${escapeHtml((cell == null ? void 0 : cell.parentComment) || "")}</textarea>
        </label>
        ...
        <div class="gradebook-v1-drawer-actions">
          ...
          <button
            ...
            type="button"
            data-gradebook-undo
            data-class-id="${escapeHtml((detail == null ? void 0 : detail.classId) || "")}"
            data-student-id="${escapeHtml((detail == null ? void 0 : detail.studentId) || "")}"
            data-grading-period-id="${escapeHtml((detail == null ? void 0 : detail.gradingPeriodId) || "")}"
            data-category="${escapeHtml((cell == null ? void 0 : cell.category) || "")}"
            data-date-key="${escapeHtml((cell == null ? void 0 : cell.dateKey) || "")}"
            data-column-key="${escapeHtml((cell == null ? void 0 : cell.columnKey) || "")}"
            data-assessment-id="${escapeHtml((cell == null ? void 0 : cell.assessmentId) || "")}"
    ...
    function toCalcEvent(event = {}) {
      ...
      return {
        ...
        mark: {
          key: ((_a2 = event.mark) == null ? void 0 : _a2.key) || "",
          symbol: ((_b = event.mark) == null ? void 0 : _b.symbol) || "",
          label: ((_c = event.mark) == null ? void 0 : _c.label) || "",
          normalizedValue: Number.isFinite(Number((_d = event.mark) == null ? void 0 : _d.normalizedValue)) ? Number(event.mark.normalizedValue) : null,
          countsTowardGrade: ((_e = event.mark) == null ? void 0 : _e.countsTowardGrade) !== false
        },
    ...
    function findOptionForCell(classState, category, markKey) {
      ...
      const options = Array.isArray((_a2 = classState == null ? void 0 : classState.keySystemOptions) == null ? void 0 : _a2[keySystemKey]) ? classState.keySystemOptions[keySystemKey] : [];
    ...
    function findCellState(rowState, context) {
      if (context.category === "assessment") {
        return (Array.isArray(rowState.assessmentCells) ? rowState.assessmentCells : []).find(
          (cell) => String(cell.stableCellKey || "") === String(context.stableCellKey || "") || String(cell.assessmentId || "") === String(context.assessmentId || "")
        ) || null;
      }
      ...
      return (Array.isArray(dateGroup.cells) ? dateGroup.cells : []).find(
        (cell) => String(cell.stableCellKey || "") === String(context.stableCellKey || "") || String(cell.columnKey || "") === String(context.columnKey || "") && String(cell.category || "") === String(context.category || "")
      ) || null;
    }
    function updateEventCollection(rowState, context, nextMarkKey, classState) {
      var _a2;
      const currentEvents = Array.isArray((_a2 = rowState == null ? void 0 : rowState.clientState) == null ? void 0 : _a2.liveEvents) ? rowState.clientState.liveEvents : [];
    ...
    function updateCellState(rowState, context, nextMarkKey, classState) {
      ...
      cell.symbol = (option == null ? void 0 : option.symbol) || "";
      cell.label = (option == null ? void 0 : option.label) || "";
      cell.normalizedValue = Number.isFinite(Number(option == null ? void 0 : option.normalizedValue)) ? Number(option.normalizedValue) : null;
      cell.tone = !option ? "empty" : option.countsTowardGrade === false ? "empty" : option.normalizedValue >= 0.85 ? "excellent" : option.normalizedValue >= 0.65 ? "strong" : option.normalizedValue >= 0.4 ? "watch" : "critical";
    }
    function applyConfirmedEventToRowState(rowState, context, eventData, classState) {
      ...
      const currentEvents = Array.isArray((_a2 = rowState == null ? void 0 : rowState.clientState) == null ? void 0 : _a2.liveEvents) ? rowState.clientState.liveEvents : [];
      const existingIndex = currentEvents.findIndex((event) => String(event.coordinateKey || "") === String(context.coordinateKey || ""));
      const markKey = String(((_b = eventData == null ? void 0 : eventData.mark) == null ? void 0 : _b.key) || "");
      if (!markKey || (eventData == null ? void 0 : eventData.action) === "clear") {
        if (existingIndex >= 0) currentEvents.splice(existingIndex, 1);
      ...
      const confirmedEvent = {
        ...
        mark: {
          key: markKey,
          symbol: String(((_c = eventData == null ? void 0 : eventData.mark) == null ? void 0 : _c.symbol) || ""),
          label: String(((_d = eventData == null ? void 0 : eventData.mark) == null ? void 0 : _d.label) || ""),
          normalizedValue: Number.isFinite(Number((_e = eventData == null ? void 0 : eventData.mark) == null ? void 0 : _e.normalizedValue)) ? Number(eventData.mark.normalizedValue) : null,
          countsTowardGrade: ((_f = eventData == null ? void 0 : eventData.mark) == null ? void 0 : _f.countsTowardGrade) !== false
        },
        metadata: {
          reviewer: "",
          revisionPortion: "",
    ...
    function applyDetailToRowState(detail) {
      const classId = String((detail == null ? void 0 : detail.classId) || "");
      const studentId = String((detail == null ? void 0 : detail.studentId) || "");
      const classState = getClassState(classId);
      const rowState = getStudentRowState(classId, studentId);
      if (!classState || !rowState || !(detail == null ? void 0 : detail.cell)) return;
      const context = {
        classId,
        studentId,
      ...
      const currentHistory = (Array.isArray(detail.history) ? detail.history : []).find((entry) => entry == null ? void 0 : entry.isCurrent);
      applyConfirmedEventToRowState(rowState, context, {
        ...
        sequenceNumber: Number((currentHistory == null ? void 0 : currentHistory.sequenceNumber) || Date.now()),
        mark: {
    ...
    function recalculateRowSummaries(rowState) {
      ...
      const summary = calc.calculateStudentSummary(
        (Array.isArray((_a2 = rowState == null ? void 0 : rowState.clientState) == null ? void 0 : _a2.liveEvents) ? rowState.clientState.liveEvents : []).map(toCalcEvent)
      );
      ...
      summaryCells.cashar.display = formatPercent(Number((_b = categoryTotals.cashar) == null ? void 0 : _b.average) * 100);
      summaryCells.cashar.value = Number.isFinite(Number((_c = categoryTotals.cashar) == null ? void 0 : _c.average)) ? Number(categoryTotals.cashar.average) : null;
      summaryCells.writing.display = formatPercent(Number((_d = categoryTotals.writing) == null ? void 0 : _d.average) * 100);
      summaryCells.writing.value = Number.isFinite(Number((_e = categoryTotals.writing) == null ? void 0 : _e.average)) ? Number(categoryTotals.writing.average) : null;
      summaryCells.subject.display = formatPercent(Number((_f = categoryTotals.subject) == null ? void 0 : _f.average) * 100);
      summaryCells.subject.value = Number.isFinite(Number((_g = categoryTotals.subject) == null ? void 0 : _g.average)) ? Number(categoryTotals.subject.average) : null;
      summaryCells.subac.display = formatPercent(Number((_h = categoryTotals.subac) == null ? void 0 : _h.average) * 100);
      summaryCells.subac.value = Number.isFinite(Number((_i = categoryTotals.subac) == null ? void 0 : _i.average)) ? Number(categoryTotals.subac.average) : null;
      summaryCells.attendance.display = formatPercent(Number((_j = categoryTotals.attendance) == null ? void 0 : _j.average) * 100);
      summaryCells.attendance.value = Number.isFinite(Number((_k = categoryTotals.attendance) == null ? void 0 : _k.average)) ? Number(categoryTotals.attendance.average) : null;
      summaryCells.behavior.display = formatPercent(Number((_l = categoryTotals.behavior) == null ? void 0 : _l.average) * 100);
      summaryCells.behavior.value = Number.isFinite(Number((_m = categoryTotals.behavior) == null ? void 0 : _m.average)) ? Number(categoryTotals.behavior.average) : null;
      summaryCells.assessment.display = formatPercent(Number((_n = categoryTotals.assessment) == null ? void 0 : _n.average) * 100);
      summaryCells.assessment.value = Number.isFinite(Number((_o = categoryTotals.assessment) == null ? void 0 : _o.average)) ? Number(categoryTotals.assessment.average) : null;
    ...
    function readFormContext(formEl) {
      ...
      const getField = (name) => {
        var _a3;
        return String(((_a3 = formEl.querySelector(`[name="${name}"]`)) == null ? void 0 : _a3.value) || "");
      };
      return {
        ...
        coordinateKey: ((_a2 = formEl.closest("[data-gradebook-cell]")) == null ? void 0 : _a2.dataset.coordinateKey) || "",
        stableCellKey: ((_b = formEl.closest("[data-gradebook-cell]")) == null ? void 0 : _b.dataset.stableCellKey) || "",
        markKey: String(((_c = formEl.querySelector("[name='markKey']")) == null ? void 0 : _c.value) || "")
      };
    }
    ...
    function optimisticApply(formEl) {
      ...
      const snapshot = clone2(rowState);
    ...
    async function handleSelectChange(selectEl) {
      ...
      try {
        const data2 = await requestJson(formEl.action, {
          method: "POST",
          formEl
        });
        ...
        if (confirmedPending) {
          ...
          if (rowState && classState && (data2 == null ? void 0 : data2.event)) {
            applyConfirmedEventToRowState(rowState, confirmedPending.context, data2.event, classState);
        ...
        cellEl == null ? void 0 : cellEl.classList.remove("is-saving");
      } catch (error2) {
        ...
        console.error("[grading-v1] cell save failed:", error2);
        window.alert(error2.message || "Grade save failed.");
      }
    }
    async function loadDrawerDetail(context, { savedMessage = "" } = {}) {
      ...
      const params = new URLSearchParams({
        ...
        gradingPeriodId: context.gradingPeriodId || ((_a2 = classState == null ? void 0 : classState.gradingPeriod) == null ? void 0 : _a2.id) || "",
        category: context.category,
        dateKey: context.dateKey,
        columnKey: context.columnKey,
        assessmentId: context.assessmentId
      ...
      try {
        const data2 = await requestJson(`/api/teacher/gradebook/cell/detail?${params.toString()}`);
        if (!(data2 == null ? void 0 : data2.detail)) {
          throw new Error("Cell details could not be loaded.");
        }
        applyDetailToRowState(data2.detail);
        setDrawerContentHtml(renderDrawerDetail(data2.detail, savedMessage));
      } catch (error2) {
        console.error("[grading-v1] drawer load failed:", error2);
        setDrawerContentHtml(renderDrawerPlaceholder("Unable to load this cell", error2.message || "Please try again."));
      }
    }
    ...
    async function submitUndo(payload2) {
      ...
      if (data2 == null ? void 0 : data2.rowState) {
        replaceRowState(data2.classId, data2.studentId, data2.rowState);
        syncRowDom(data2.classId, data2.studentId);
      }
      return data2;
    }
    async function handleDrawerFormSubmit(formEl) {
      ...
      if (!(data2 == null ? void 0 : data2.detail)) {
        throw new Error((data2 == null ? void 0 : data2.message) || "Cell details could not be saved.");
      }
      applyDetailToRowState(data2.detail);
      setDrawerContentHtml(renderDrawerDetail(data2.detail, data2.message || "Cell details saved."));
    }
    function bindKeyboardNavigation(event) {
      ...
      if (event.key === "ArrowLeft" || event.key === "ArrowRight") {
        ...
        (_a2 = nextCell == null ? void 0 : nextCell.querySelector("[data-gradebook-select]")) == null ? void 0 : _a2.focus();
        return;
      }
      const tableBody = currentRow.parentElement;
      const allRows = Array.from((tableBody == null ? void 0 : tableBody.querySelectorAll("[data-gradebook-row]")) || []);
      ...
      (_c = (_b = nextRowCells[cellIndex]) == null ? void 0 : _b.querySelector("[data-gradebook-select]")) == null ? void 0 : _c.focus();
    }
    document.addEventListener("change", (event) => {
      ...
      if (focusDateInput instanceof HTMLInputElement && focusDateInput.matches("[data-gradebook-focus-date]")) {
        (_a2 = focusDateInput.form) == null ? void 0 : _a2.requestSubmit();
      }
    });
    document.addEventListener("submit", (event) => {
      ...
      event.preventDefault();
      handleDrawerFormSubmit(drawerForm).catch((error2) => {
        console.error("[grading-v1] drawer save failed:", error2);
        window.alert(error2.message || "Cell detail save failed.");
      });
    });
    document.addEventListener("keydown", (event) => {
      ...
      if ((event.metaKey || event.ctrlKey) && event.key.toLowerCase() === "z") {
        ...
        event.preventDefault();
        submitUndo(lastMutation).catch((error2) => window.alert(error2.message));
      }
    });
    document.addEventListener("click", (event) => {
      ...
      if (undoButton) {
        ...
        }).catch((error2) => window.alert(error2.message));
      }
    });
